import { Node, Zodiac, Element, zodiacElement, standardNodes, Sect, standardZodiac, classicalDignityData, modernDignityData } from '../defs/astroDefs.ts';
import { DignityMode, TriplicityMode, FaceMode, BoundsMode } from '../defs/settingsDefs.ts';
