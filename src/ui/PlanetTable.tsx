...
import { getDignityState, getBoundLord, getFaceLord, getTriplicityRole, Dignity, type TriplicityRole } from '../model/dignities';
import type { AngleProximityInfo } from '../model/chartAnalysis';
