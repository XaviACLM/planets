...
const EsotericModePanel: FC<EsotericModePanelProps> = ({
	...
	return (
		<div
			className="absolute bottom-4 left-4 bg-theme-bg backdrop-blur-sm text-theme-text px-4 py-3 font-mono text-sm border border-theme-border z-[1000] flex items-center gap-3"
