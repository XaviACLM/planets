...
import { Node, Zodiac, Mode, Element, mainAngles, arabicParts } from '../defs/astroDefs';
import { AspectKind } from '../defs/aspectDefs';
import { type DispositorChain, type FinalDispositors, getFinalDispositorsOfChain } from '../model/rulershipGraph.ts'
import {
	zodiacSymbols,
	zodiacShortNames,
	nodeSymbols,
